...
run_job default EAP.py known_1000 EleutherAI/pythia-14m
run_job default EAP.py lama_trex EleutherAI/pythia-1b
run_job default EAP_IG.py lama_trex AlgorithmicResearchGroup/gpt2-xs
run_job default EAP_vit.py officehome vit_tiny_patch16_224
run_job default EAP_IG_vit.py officehome vit_tiny_patch16_224

wait_for_default_done
rename_once

run_job logit_diff EAP.py known_1000 EleutherAI/pythia-14m
run_job logit_diff EAP.py lama_trex EleutherAI/pythia-1b
run_job logit_diff EAP_IG.py lama_trex AlgorithmicResearchGroup/gpt2-xs
run_job logit_diff EAP_vit.py officehome vit_tiny_patch16_224
run_job logit_diff EAP_IG_vit.py officehome vit_tiny_patch16_224
